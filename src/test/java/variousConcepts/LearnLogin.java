...
public class LearnLogin {
	...
	WebDriver driver; // Global Variable - Object variable.
	...
	public void init() {
		...
		// These much needed for our init method
	...
	public void testLogin() throws InterruptedException {
		...
		// Asking the driver to find the WebElement and store that
		...
		// It is like String Variable in Java
		// Its like a Local/Regular Variable we are creating. Thats why the driver is
		// not involved in it and not going crazy.
		...
		//Till Here Code is.
		// -------->>>ACTUAL CODE IS TILL ABOVE--------->>>

		// --------->>>below are just examples for Exceptions------>>>

		// Creating WebDriverWait object
		WebDriverWait wait = new WebDriverWait(driver, 20);
		wait.until(ExpectedConditions.visibilityOfElementLocated(DASHBOARD_HEADER_FIELD));// calling wait object
		...
		// e.getMessage(); -----// or we can use e.getStackTrace();
		// }

		//--->> If it is false or their is Error only it we get the below message--->>
